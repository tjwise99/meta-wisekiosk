(function () {
  ...
  var WARM = 20, ARMLEN = 100, NSLOT = 5;
  var COND = [0, 1, 2, 1, 0];
  ...
  function ensure() {
    ...
    if (!testEl) {
      ...
      testEl.style.cssText =
        'position:fixed;left:40px;top:40px;width:240px;height:80px;' +
        'background:#333;color:#999;font:14px sans-serif;z-index:2147483647;';
      testEl.textContent = 'floor probe';
      ...
      try {
        ...
        sh.insertRule(
          ...
          '50%{transform:translateX(-160px)}100%{transform:translateX(0)}}',
          sh.cssRules.length);
        mech = 'css';
      } catch (e) {
